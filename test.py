...
class Service_Schedule_PDF_Generator:
    ...
    def init_pdf(self):
        ...
        self.GRAY = (48/255,102/255,11/255) ##30666f
        self.BLACK = (0,0,0)
        self.WHITE = (1,1,1)
    ...
    def draw_header(self):
        image_filename = os.path.join(self.current_path, "assets", "image", "bg_workbook.png")
        self.inv_canvas.drawImage(image_filename, 0, 0, width=A4[0], height=A4[1], mask='auto')
